...
import { getAllMateriPokok, MateriPokok } from '../../services/materi/materiPokokService.tsx'; // Impor dari service
    ...
    useEffect(() => {
        const fetchMateri = async () => {
            try {
                ...
                setMateriList(data);
            } catch (e: unknown) { // 1. Tipekan error sebagai 'unknown'
                // 2. Periksa apakah error adalah instance dari Error
                if (e instanceof Error) {
                    setError(e.message); // Aman untuk mengakses properti .message
                } else {
