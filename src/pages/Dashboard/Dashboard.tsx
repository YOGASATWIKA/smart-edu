...
export default function AIWriterDashboard() {
  return (
    <>
          ...
          <a href="/generate" className="group mx-auto block max-w-md text-left no-underline">
            ...
            >
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">
                Mulailah dengan membuat kerangka tulisan yang terstruktur untuk artikel, blog, atau laporan Anda.
              </p>
              <div
      ...
      <h2 className="mt-5 font-semibold text-lg text-gray-900 dark:text-white sm:text-xl">
        Aktifitas Terakhir
      </h2>
      <div className="mt-5  rounded-2xl border border-gray-200 bg-white p-5 py-7 shadow-sm dark:border-gray-800 dark:bg-gray-900 xl:px-10 xl:py-12">
