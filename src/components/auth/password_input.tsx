...
const PasswordInput = ({
    ...
    return (
        <div className="mb-6">
            ...
            {/* Wrapper dengan posisi relatif untuk menampung tombol ikon */}
            <div className="relative">
                <input
                    ...
                    // Tambahkan padding kanan (pr-10) untuk memberi ruang bagi ikon
                    ...
                    required
                />
                {/* Tombol ikon diposisikan absolut di dalam wrapper */}
                <button
