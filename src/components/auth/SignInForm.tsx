...
import { useAuth } from '../../hooks/useAuth'; // <-- Impor custom hook kita

export default function SignInForm() {
    // Panggil hook untuk mendapatkan semua logika dan state
    const { login, isLoading, error } = useAuth();

    // --- Bagian Tampilan (JSX) tidak banyak berubah, hanya lebih bersih ---
    return (
            ...
            <div className="w-full max-w-sm rounded-2xl border border-slate-200 bg-white p-6 shadow-lg dark:border-slate-700 dark:bg-slate-800 sm:p-8">
                <div className="mb-8 text-center">
                    ...
                    <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">
                        Sign in to continue to SmartEdu.
                    </p>
                </div>

                <div>
                    <button
                        onClick={() =>!isLoading && login()} // <-- Cukup panggil fungsi login dari hook
                        disabled={isLoading}
...
//
//       if (token) {
//         // ✅ FUNGSI PENTING: Menyimpan token DAN data pengguna
...
//   });
//
//   // --- Bagian Tampilan (JSX) dengan Desain Kotak Form ---
//   return (
//     <div className="flex flex-1 flex-col items-center justify-center p-4">
//
//       {/* ✅ INI KOTAK FORM YANG DIMINTA */}
//       <div className="w-full max-w-sm rounded-2xl border border-slate-200 bg-white p-6 shadow-lg dark:border-slate-700 dark:bg-slate-800 sm:p-8">
//         <div className="mb-8 text-center">
//           <h1 className="text-2xl font-bold text-slate-800 dark:text-white sm:text-3xl">
//             Welcome Back
